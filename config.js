...
module.exports = {
  ...
  CAPTION: process.env.CAPTION || "♛ᴀɴꜱʜ›™-263",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "♛ᴀɴꜱʜ›™-263",
  BOT_NAME: process.env.BOT_NAME || "♛ᴀɴꜱʜ›™-263",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "♛ᴿᴼᵞᴬᴸ›™-263,❤️",
  AUDIO_DATA: process.env.AUDIO_DATA || "ANSH;ᴀɴꜱʜ›™-263-ᴠ3;https://telegra.ph/file/06626ef7c51d90f3c19b8.jpg",
  PROCESSNAME: process.env.PROCESSNAME || "♛ᴀɴꜱʜ›™-263",
